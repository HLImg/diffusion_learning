...
class ScoreNet(nn.Module):
    def __init__(self, marginal_prob_std, channels=[32, 64, 128, 256], embed_dim=256):
        ...
        :param marginal_prob_std: A function that takes time t and gives the standard
        deviation of the perturbation kernel p_{0t}(x(t) | x(0)).
        :param channels: The number of channels for feature maps of each resolution.
        :param embed_dim: The dimensionality of Gaussian random feature embeddings.
        """
        super().__init__()
